							...
							<div class="row">
								<div class="col-12 col-sm-12 col-md-12 col-lg-12">
									<div class="form-group">
										...
										<form:input path="username" ng-model="username" name="username" required="required" placeholder="Nhập tên đăng nhập"
								...
								<div class="col-12 col-sm-12 col-md-12 col-lg-12">
									<div class="form-group">
										<label for="CustomerEmail">Email<span
												style="color: red">*</span></label>
										<form:input path="email" ng-model="email" name="email" required="required" placeholder="Địa chỉ email"
								...
								<div class="col-12 col-sm-12 col-md-12 col-lg-12">
									<div class="form-group">
										...
										<form:password path="password" ng-model="password" value="" required="required"
											name="password" placeholder="Nhập mật khẩu" id="CustomerPassword" class=""/>
								...
								<div class="col-12 col-sm-12 col-md-12 col-lg-12">
									<div class="form-group">
										<label for="CustomerPassword">Xác nhận mật khẩu<span
												style="color: red">*</span></label>
										<form:password path="" ng-model="password1" value=""
											name="password1" required="required" placeholder="Xác nhận mật khẩu"
