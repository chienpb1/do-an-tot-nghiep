                            ...
                            <fieldset>
                                ...
                                <div class="row">
                                    <div class="form-group col-md-12 col-lg-12 col-xl-12 required">
                                        ...
                                        <input disabled="disabled"
                                               name="phoneNumber"
                                               value="${order.account.phoneNumber}"
                                               id="input-phone" type="email">
                                    </div>
                                </div>
                            </fieldset>
                            <fieldset>
                            ...
                            <fieldset>
                                <div class="row">
                                    <div class="form-group col-md-12 col-lg-12 col-xl-12">
                                        ...
                                        <textarea disabled="disabled" name="note"
                                                  class="form-control
                                                  resize-both" rows="3">${order.note}</textarea>
                                    </div>
                                </div>
                            </fieldset>
                        </form>
                                ...
                                <table class="bg-white table table-bordered table-hover text-center">
                                    ...
                                    <c:forEach var="o" items="${order.orderDetails}">
                                        <tr>
                                            ...
                                            <td><fmt:formatNumber value="${o.price}" currencyCode="VND"/></td>
                                            <td>${o.quantity}</td>
                                            <td><fmt:formatNumber value="${o.price * o.quantity}" currencyCode="VND"/></td>
                                        </tr>
                                    </c:forEach>
                                    </tbody>
                                    <tfoot class="font-weight-600">
                                    <tr>
                                        <td colspan="3" class="text-right font-weight-bold">Thanh toán
                                        </td>
                                        <td class="font-weight-bold"><fmt:formatNumber value="${total}" currencyCode="VND"/></td>
                                    </tr>
                                    </tfoot>
                                </table>
                            </div>
