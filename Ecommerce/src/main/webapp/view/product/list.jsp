            ...
            <div class="collection-hero">
                <div class="collection-hero__image">
                    <img class="blur-up lazyload"
                         autocapitalize="characters" data-src="/assets/images/banner_product_brand.jpg"
                         src="/assets/images/banner_product_brand.jpg" alt="Women" title="Banner"/>
                </div>
                        ...
                        <div class="sidebar_widget filterBox filter-widget">
                            ...
                            <form action="">
                                <button formaction="/product/list/price/under100"
                                        class="btn mb-2 btn--secondary">Dưới 100K
                                </button>
                                <button formaction="/product/list/price/100-300"
                                        class="btn mb-2 btn--secondary">Từ 100K - 300K
                                </button>
                                <button formaction="/product/list/price/300-900"
                                        class="btn mb-2 btn--secondary">Từ 300K - 900K
                                </button>
                                <button formaction="/product/list/price/over900"
                                        class="btn mb-2 btn--secondary">Trên 900K
                                </button>
                            </form>
                        </div>
                        <!--End Price Filter-->
                                        ...
                                        <div class="product-image">
                                            ...
                                            <c:if test="${empty sessionScope.userAdmin}">
                                                <form class="variants add">
                                                    <c:set var="qty" value="${p.product.unitsInStock}"/>
...
<%--                                            </div>--%>
                                        ...
                                        <div class="product-details text-center">
                                            ...
                                            <div class="product-price">
                                                <span class="price"><fmt:formatNumber value="${p.product.price}" type="currency" currencyCode="VND" /></span>
                                            </div>
                                            <!-- End product price -->
                                            <!-- Variant -->
                                            <ul class="swatches">
