                ...
                <div class="container">
                    ...
                    <div class="footer-top">
                        <div class="row">
                            <div class="col-12 col-sm-12 col-md-3 col-lg-3 contact-box">
                                ...
                                <ul class="addressFooter">
                                    <li><i class="icon anm anm-map-marker-al"></i>
                                        <p>66 Hồ Tùng Mậu, Mai Dịch, Hà Nội</p>
                                    </li>
                                    <li class="phone"><i class="icon anm anm-phone-l"></i>
                                        <p>0888 738 149</p>
                                    </li>
                                    <li class="email"><i class="icon anm anm-envelope-l"></i>
                                        <p>phambachien.haui@gmail.com</p>
                                    </li>
                                </ul>
                            ...
                            <div class="col-12 col-sm-12 col-md-3 col-lg-3 footer-links">
                                <h4 class="h4">Chính sách</h4>
                                <ul>
                                    <li><a href="#">Chính sách giao hàng</a></li>
                                    <li><a href="#">Chính sách thanh toán</a></li>
                                    <li><a href="#">Chính sách đổi trả hàng</a></li>
                                    <li><a href="#">Chinh sách bảo mật thông tin</a></li>
                                ...
                                <div class="display-table">
                                    <div class="display-table-cell footer-newsletter">
                                        <form action="#" method="post">
                                            <label class="h4">Đăng ký nhận tin</label>
                                            <p>Đăng ký để nhận thông tin sản phẩm mới nhất và chương trình khuyến mãi</p>
                                            <div class="input-group">
                                                <input type="email" class="input-group__field newsletter__input"
                                                    name="EMAIL" value="" placeholder="Email của bạn" required="">
                                                <span class="input-group__btn">
                                                    <button type="submit" class="btn newsletter__submit" name="commit"
                                                        id="Subscribe"><span
                                                            class="newsletter__submit-text--large">Đăng ký</span></button>
                                                </span>
                                            </div>
                                        </form>
                                    </div>
                    ...
                    <div class="footer-bottom">
                        <div class="row">
                            ...
                            <div
                                ...
                                <span>By</span> <a href="https://www.facebook.com/pbchien.haui/">Pham Ba Chien</a>
                            </div>
