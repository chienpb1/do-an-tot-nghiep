		...
		<div class="search__form">
			<form class="search-bar__form" action="/product/list">
				...
				<input class="search__input" type="search" name="kw"
					...
					placeholder="Hôm nay bạn cần tìm gì...?" aria-label="Search"
					autocomplete="off">
			</form>
...
<%--					</div>--%>
					<p class="phone-no">
						<i class="anm anm-phone-s"></i> 0888 738 149
					</p>
				</div>
				...
				<div class="col-md-8 text-right">
					...
					<ul class="customer-links list-inline">
						...
						<c:if test="${not empty sessionScope.userAdmin}">
							<li><a href="/admin">Công cụ quản trị</a></li>
						</c:if>
						<c:if test="${not empty sessionScope.user }">
								...
								<div class="megamenu style4">
									<ul class="grid grid--uniform mmWrapper">
										<li class="grid__item lvl-1 col-md-3 col-lg-3"><a
											href="#" class="site-nav lvl-1">Phụ kiện điện tử</a>
											<ul class="subLinks">
